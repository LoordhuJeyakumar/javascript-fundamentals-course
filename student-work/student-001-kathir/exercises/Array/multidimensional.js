...
// 1.1: Access element at row 2, column 2
console.log("\n1.1 Access element at row 2, column 2:");
let element = matrix2D[2][2];
console.log("Element at [1][2]:",element);

// 1.2: Print all elements of the matrix
...
// 2.1: Access element at depth 1, row 0, column 1
console.log("\n2.1 Access element at [1][0][1]:");
let element3D = matrix3D[1][0][1];
console.log("Element at [1][0][1]:",element3D);

// 2,2: Print all elements of the 3D matrix
...
for(let i = 0;i < matrixA.length;i++){
    scalarProduct[i] = [];
    for(let j = 0;j < matrixA[i].length;j++){
        scalarProduct[i][j] = matrixA[i][j] * 2;
    }
}
console.log("Matrix A * 2:",scalarProduct);

// Ex 4: Matrix Transpose
console.log("\n4. Matrix Transpose:");
...
// 5.1: Find the student with the highest grade
...
// 6.2: Count the depth of nesting
...
// Ex 8: Array of Arrays Processing
...
// 8.2: Find the best performing quarter
...
// 9.1: Create a 5x5 identity matrix
...
// 9.2: Create a multiplication table
